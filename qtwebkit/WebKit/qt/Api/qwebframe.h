...
public:
    ...
    bool allowAccess() const;
    void setAllowAccess(bool allow = true);

    void emitNetworkResourceReply(QNetworkReply* reply)
    { 
      emit networkResourceReply(reply);
    }
...
Q_SIGNALS:
    ...
    void networkResourceRequest(QNetworkRequest* request);
    void networkResourceReply(QNetworkReply* reply);
